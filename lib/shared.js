...
var RESERVED_GROUP_NAMES = [
    ...
    'tecan', 'thermofisher', 'roche', 'siemens', 'agilent', 'danaher',
    'beckmancoulter', 'perkinelmer', 'revvity', 'biorad', 'qiagen',
    'opentrons', 'biosero', 'azenta', 'inheco', 'liconic', 'labware',
    'automata', 'swisslog', 'slas'
];
