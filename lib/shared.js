 ...
 */
var RESERVED_TAGS = ['system', 'hamilton', 'oem', 'read-only', 'stared', 'starred', 'signed', 'unsigned', 'registered', 'unregistered'];
 ...
 */
var RESERVED_GROUP_NAMES = ['starred', 'oem', 'hamilton', 'system', 'signed', 'unsigned', 'registered', 'unregistered', 'all', 'recent', 'import', 'export', 'history'];
